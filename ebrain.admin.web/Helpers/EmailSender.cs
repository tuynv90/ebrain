...
namespace Ebrain.Helpers
{
    public class EmailSender
    {
        ...
        public static void SendEmailAsync(string recepientName, string[] recepientEmail,
           string subject, string body, SmtpConfig config = null, bool isHtml = true)
        {
            foreach (var item in recepientEmail)
            {
                SendEmailAsync(recepientName, item, subject, body, config, isHtml);
            }
