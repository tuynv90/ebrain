...
export class AuthService {
    ...
    constructor(private router: Router, private configurations: ConfigurationService, injector:Injector, private localStorage: LocalStoreManager) {
        setTimeout(() => this.endpointFactory = injector.get(EndpointFactory));
