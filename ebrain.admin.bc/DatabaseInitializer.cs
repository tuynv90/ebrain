    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await createUserAsync("admin", "tempP@ss123", "Inbuilt Administrator", "johnpham@ymail.com", "+84 (907) 477-489", new string[] { adminRoleName });
                await createUserAsync("user", "tempP@ss123", "Inbuilt Standard User", "lt.quang.it@gmail.com", "+84 (944) 776-636", new string[] { userRoleName });
