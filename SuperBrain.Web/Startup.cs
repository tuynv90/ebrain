...
using superbrain.web.Authorization;
using superbrain.web.Helpers;
using superbrain.web.ViewModels;
using Swashbuckle.AspNetCore.Swagger;
using System;
using AppPermissions = ebrain.admin.bc.Core.ApplicationPermissions;

namespace superbrain.web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("superbrain.web"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "superbrain.web API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "superbrain.web API V1");
            });
